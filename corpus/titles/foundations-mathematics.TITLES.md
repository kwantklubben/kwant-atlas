...
1. *Internal* — **`calculus.pdf` foundation note** (single-variable-only, thin).
3. **James Stewart, Daniel Clegg & Saleem Watson — *Calculus: Early Transcendentals*** (9th ed., 2020, Cengage).
3. **Michael Spivak — *Calculus*** (4th ed., 2008, Publish or Perish).
3. **John H. Hubbard & Barbara Burke Hubbard — *Vector Calculus, Linear Algebra, and Differential Forms*** (5th ed., 2015, Matrix Editions).
3. **Carl P. Simon & Lawrence Blume — *Mathematics for Economists*** (1994, W. W. Norton).
...
3. **Dimitri P. Bertsekas — *Nonlinear Programming*** (3rd ed., 2016, Athena Scientific).
...
3. **Geoffrey Grimmett & David Stirzaker — *Probability and Random Processes*** (3rd ed., 2001, Oxford University Press).
3. **David Williams — *Probability with Martingales*** (1991, Cambridge University Press).
3. **Kai Lai Chung — *A Course in Probability Theory*** (3rd ed., 2001, Academic Press).

## stochastic-calculus
1. **Steven E. Shreve — *Stochastic Calculus for Finance I: The Binomial Asset Pricing Model*** (2004, Springer).
1. **Steven E. Shreve — *Stochastic Calculus for Finance II: Continuous-Time Models*** (2004, Springer).
1. **Tomas Björk — *Arbitrage Theory in Continuous Time*** (4th ed., 2020, Oxford University Press).
3. **Bernt Øksendal — *Stochastic Differential Equations*** (6th ed., 2003, Springer).
3. **J. Michael Steele — *Stochastic Calculus and Financial Applications*** (2001, Springer).
3. **Fima C. Klebaner — *Introduction to Stochastic Calculus with Applications*** (3rd ed., 2012, Imperial College Press).
...
3. **George E. P. Box, Gwilym M. Jenkins, Gregory C. Reinsel & Greta M. Ljung — *Time Series Analysis: Forecasting and Control*** (5th ed., 2015, Wiley).

## numerical-methods
1. **Paul Glasserman — *Monte Carlo Methods in Financial Engineering*** (2003, Springer).
3. **Lloyd N. Trefethen & David Bau III — *Numerical Linear Algebra*** (1997, SIAM).
3. **Lloyd N. Trefethen — *Numerical Analysis*** (2019, SIAM).
3. **Gene H. Golub & Charles F. Van Loan — *Matrix Computations*** (4th ed., 2013, Johns Hopkins University Press).
3. **Peter E. Kloeden & Eckhard Platen — *Numerical Solution of Stochastic Differential Equations*** (1992, Springer).
...
3. **Richard P. Stanley — *Enumerative Combinatorics, Vol. 1*** (2nd ed., 2011, Cambridge University Press).
3. **Donald E. Knuth — *The Art of Computer Programming*** (Vols. 1–4, Addison-Wesley).
