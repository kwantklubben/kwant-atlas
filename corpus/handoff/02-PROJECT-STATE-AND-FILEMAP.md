...
- **In progress:** Pillar 5 (Portfolio Optimization) — **DONE** (9 topic-folders: modern-portfolio-theory-and-mean-variance, covariance-shrinkage-and-denoising, black-litterman, risk-parity-and-equal-risk-contribution, hierarchical-risk-parity, robust-optimization, kelly-criterion-and-bet-sizing, constraints-and-transaction-costs, multi-asset-and-factor-allocation). Lockstep running; audit pending.
- **In progress:** Pillar 7 (Machine Learning & Alt-Data, dir `07-machine-learning-altdata`) — financial-ml-pitfalls-and-low-snr, purged-cross-validation-and-backtest-hygiene committed; tree-boosting, financial-NLP, alt-data-pipelines, deep-learning building.
