...
- **In progress/complete:** Pillar 2 (Algorithmic Trading & HFT) — **9 topic-folders** (optimal-execution-and-almgren-chriss, execution-algorithms-vwap-twap-pov, queue-position-and-fill-probability, market-microstructure-and-order-types, smart-order-routing-and-fragmentation, execution-backtesting-and-simulation, colocation-and-clock-synchronization, hardware-acceleration-and-fpga, low-latency-systems-architecture). Lockstep + audit running.
- **In progress:** Pillar 8 (Quant Dev, dir `08-quantitative-development`) — 4 committed (high-performance-cpp-for-trading, low-latency-linux-and-networking, tick-level-databases-and-timeseries, event-driven-backtesting-engines). Building: concurrency-and-lockless-programming, fix-protocol-and-exchange-connectivity, python-quant-stack. Remaining: data-infrastructure-and-reproducibility, production-trading-systems (~9 folders target).
