...
> **Scale:** 104 topic-folders, 728 content pages (excl. `_legacy/`), 800+ runnable Python blocks. 37 superseded flat notes archived in `_legacy/` (excluded from the published site).
>
> **Frontier layer added (2026-09-11):** 7 research-grade folders — P3 rough-volatility-and-fractional-models, local-stochastic-volatility-models, deep-hedging-and-bsdes, path-signatures-and-rough-paths; P2 market-microstructure-game-theory; P4 climate-and-esg-risk; P6 crypto-and-defi-market-making.
