...
- **In progress:** Pillar 7 (Machine Learning & Alt-Data, dir `07-machine-learning-altdata`) — 7 committed: financial-ml-pitfalls-and-low-snr, purged-cross-validation-and-backtest-hygiene, tree-and-boosting-methods, financial-nlp-and-transcripts, alternative-data-pipelines-and-evaluation, deep-learning-for-sequences, reinforcement-learning-for-trading. Building: regime-classification-hmm-and-gmm, ml-for-portfolio (→9).
- **In progress:** Pillar 6 (Market Making) — started; limit-order-book-mechanics, avellaneda-stoikov building.
- **Remaining pillars:** 2, 8 (corpus + free/paid sources ready). Then each completed pillar gets its audit. Each built via the same folder-per-topic + lockstep pattern.
