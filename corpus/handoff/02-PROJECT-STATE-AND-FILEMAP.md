...
- **In progress:** Pillar 5 (Portfolio Optimization) — **DONE** (9 topic-folders: modern-portfolio-theory-and-mean-variance, covariance-shrinkage-and-denoising, black-litterman, risk-parity-and-equal-risk-contribution, hierarchical-risk-parity, robust-optimization, kelly-criterion-and-bet-sizing, constraints-and-transaction-costs, multi-asset-and-factor-allocation). Lockstep done; audit running.
- **In progress:** Pillar 7 (Machine Learning & Alt-Data, dir `07-machine-learning-altdata`) — 6 committed: financial-ml-pitfalls-and-low-snr, purged-cross-validation-and-backtest-hygiene, tree-and-boosting-methods, financial-nlp-and-transcripts, alternative-data-pipelines-and-evaluation, deep-learning-for-sequences. Building: regime-classification-hmm-and-gmm, ml-for-portfolio, reinforcement-learning-for-trading (→9).
- **Remaining pillars:** 6, 2, 8 (corpus + free/paid sources ready). Each built via the same folder-per-topic + lockstep pattern.
