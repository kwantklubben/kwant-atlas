...
- **In progress:** Pillar 5 (Portfolio Optimization) — 10 topic-folders target; first 2 building.
- **Remaining pillars:** 5, 7, 6, 2, 8 (corpus + free/paid sources ready). Each built via the same folder-per-topic + lockstep pattern.
