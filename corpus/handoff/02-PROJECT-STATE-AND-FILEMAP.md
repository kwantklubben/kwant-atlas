...
- **In progress:** Pillar 7 (Machine Learning & Alt-Data, dir `07-machine-learning-altdata`) — **DONE + lockstep** (9 topic-folders: financial-ml-pitfalls-and-low-snr, purged-cross-validation-and-backtest-hygiene, tree-and-boosting-methods, financial-nlp-and-transcripts, alternative-data-pipelines-and-evaluation, deep-learning-for-sequences, reinforcement-learning-for-trading, regime-classification-hmm-and-gmm, ml-for-portfolio). Audit running.
- **In progress:** Pillar 6 (Market Making) — 4 folders committed: limit-order-book-mechanics, avellaneda-stoikov-and-optimal-quoting, adverse-selection-and-glosten-milgrom, spread-decomposition-and-roll-model. Building: inventory-management-and-quote-skewing, toxic-order-flow-and-vpin, market-impact-and-depth. Remaining: liquidity-risk-and-asset-pricing, market-maker-economics-and-rebates.
- **Remaining pillars:** 2, 8 (corpus + free/paid sources ready; each ~7-10 topic-folders). Then remaining audits (Pillar 4 note: numbered 11 folders then +copulas/systemic — all committed). Each built via the same folder-per-topic + lockstep pattern.
