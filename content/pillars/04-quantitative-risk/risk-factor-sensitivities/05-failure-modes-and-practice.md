...
- Sibling: [[pillars/03-derivative-pricing/black-scholes-merton/05-failure-modes-and-practice|Pillar 3 · BSM Failure Modes]] (the same breakdowns, viewed from pricing) · [[pillars/04-quantitative-risk/extreme-value-theory-and-fat-tails|Extreme Value Theory & Fat Tails]]
