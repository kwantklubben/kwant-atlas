...
5. **The factor zoo / multiple testing.** Expected false discoveries $=0.0455M$; use $t>3$ or BH-FDR; state the number of configurations you tried. See [[pillars/01-quantitative-research/backtesting-hygiene-and-deflated-sharpe|Backtesting Hygiene & Deflated Sharpe]].
...
- Discipline: [[pillars/01-quantitative-research/backtesting-hygiene-and-deflated-sharpe|Backtesting Hygiene & Deflated Sharpe]] · [[pillars/01-quantitative-research/regime-detection/index|Regime Detection]] (detecting the state change)
