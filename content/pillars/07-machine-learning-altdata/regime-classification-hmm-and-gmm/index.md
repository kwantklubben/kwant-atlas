...
- ML siblings (this pillar): [[pillars/07-machine-learning-altdata/financial-ml-pitfalls-and-low-snr/index|Financial ML Pitfalls & Low-SNR]] (the evaluation discipline every regime label inherits) · [[pillars/07-machine-learning-altdata/tree-and-boosting-methods/index|Tree & Boosting Methods]] (supervised labelers) · [[pillars/07-machine-learning-altdata/purged-cross-validation-and-backtest-hygiene|Purged & Embargoed CV]] (honest OOS for regime-conditional strategies) · [[pillars/07-machine-learning-altdata/ml-for-portfolio/index|ML for Portfolio Construction]] (regime-conditional allocation) · [[pillars/07-machine-learning-altdata/deep-learning-for-sequences/index|Deep Learning for Sequential Data]]
