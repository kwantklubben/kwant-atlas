...
1. **Look-ahead in replay.** Fills decided from post-decision events inflate fill rates (the toy replay's $P(\text{fill})$ went $0.3301\!\to\!1.0000$ with a $2\times$ horizon); in production this is the single most common reason a replay-tuned algo underperforms live.
