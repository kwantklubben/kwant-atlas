...
2. **Latency pick-off.** Stale quotes get filled by faster takers at the wrong moment; loss grows roughly linearly in latency ($\$0.025\to\$0.993$ per fill as latency goes $0.05\to10$ ms). *Fix:* cancel-ahead / quote-fade logic and genuine latency reduction ([[pillars/02-algorithmic-hft/low-latency-systems-architecture|Low-Latency Systems Architecture]]).
