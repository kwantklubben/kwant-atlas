...
| P(informed $\mid$ buy) | $\dfrac{2\pi\theta_{t-1}}{2\pi\theta_{t-1}+1-\pi}$ ($=\pi$ at $\theta_{t-1}=\tfrac12$) | toxicity of a fill |
...
**Beginner:** start at [[pillars/06-market-making/adverse-selection-and-glosten-milgrom/01-from-zero-intuition|01]] · **Practitioner:** start at [[pillars/06-market-making/adverse-selection-and-glosten-milgrom/05-failure-modes-and-practice|05]]