...
- Related: [[pillars/06-market-making/spread-decomposition-and-roll-model|Spread Decomposition & the Roll Model]] (the $\lambda$-and-$c$ decomposition of the spread) · [[pillars/06-market-making/limit-order-book-mechanics-and-l3/index|Limit Order Book Mechanics]] (where the book's depth is actually observed)
