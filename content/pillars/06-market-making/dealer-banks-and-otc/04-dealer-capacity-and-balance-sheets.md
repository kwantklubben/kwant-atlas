...
gamma, sigma, q = 2.0, 0.20, 1.0e9          # risk aversion, vol, shock size (shares)

def impact(E):  return (gamma*sigma**2/E)*q  # price concession (fraction)

print("Immediate price impact of absorbing q=1e9 shares vs dealer capital E:")
for E in (2e9, 5e9, 1e10, 2.5e10, 1e11):
    print(f"  E={E:.2e}: impact={impact(E)*100:7.3f}%   impact*E={impact(E)*E:.4e}")

print("\nSlow capital arrival E0=2e9 -> Einf=1e11, T=1.0y (the reversal):")
E0, Einf, T = 2e9, 1e11, 1.0
for t in (0.0, 0.1, 0.25, 0.5, 1.0, 2.0):
    Et = E0 + (Einf-E0)*(1-np.exp(-t/T))
    print(f"  t={t:4.2f}y  E(t)={Et:.3e}  impact={impact(Et)*100:7.4f}%")
print(f"  half-life of reversal = T ln2 = {T*np.log(2):.4f} y")
```
```text
Immediate price impact of absorbing q=1e9 shares vs dealer capital E:
  E=2.00e+09: impact=  4.000%   impact*E=8.0000e+07
  E=5.00e+09: impact=  1.600%   impact*E=8.0000e+07
  E=1.00e+10: impact=  0.800%   impact*E=8.0000e+07
  E=2.50e+10: impact=  0.320%   impact*E=8.0000e+07
  E=1.00e+11: impact=  0.080%   impact*E=8.0000e+07

Slow capital arrival E0=2e9 -> Einf=1e11, T=1.0y (the reversal):
  t=0.00y  E(t)=2.000e+09  impact= 4.0000%
  t=0.10y  E(t)=1.133e+10  impact= 0.7063%
  t=0.25y  E(t)=2.368e+10  impact= 0.3379%
  t=0.50y  E(t)=4.056e+10  impact= 0.1972%
  t=1.00y  E(t)=6.395e+10  impact= 0.1251%
  t=2.00y  E(t)=8.674e+10  impact= 0.0922%
  half-life of reversal = T ln2 = 0.6931 y
```
