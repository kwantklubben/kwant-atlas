...
- Foundational base: [[foundations/stochastic-calculus-and-ito|Stochastic Calculus & Itô]] · [[pillars/03-derivative-pricing/black-scholes-merton-and-feynman-kac|Black-Scholes-Merton & Feynman-Kac]] (the vanilla anchor all exotics reduce to)
- Sibling topics: [[pillars/03-derivative-pricing/no-arbitrage-and-binomial-trees|No-Arbitrage & Binomial Trees]] · [[pillars/03-derivative-pricing/the-greeks-and-dynamic-hedging|The Greeks & Dynamic Hedging]] · [[pillars/03-derivative-pricing/implied-volatility-surface-and-smiles|Implied Volatility Surfaces]] · [[pillars/03-derivative-pricing/advanced-volatility-heston-and-sabr|Heston & SABR]]
...
- Forward: [[pillars/03-derivative-pricing/advanced-volatility-heston-and-sabr|Heston & SABR]] (model risk for the closed forms) · [[foundations/multivariable-calculus-and-optimization|Multivariable Calculus]]
