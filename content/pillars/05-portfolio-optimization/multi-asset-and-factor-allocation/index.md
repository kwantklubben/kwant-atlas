...
w6040 = np.array([0.60, 0.40, 0.0, 0.0])
...
- **Absolute beginner:** [[pillars/05-portfolio-optimization/multi-asset-and-factor-allocation/01-from-zero-intuition|01 · From Zero]] — no prior knowledge needed.
- **Allocation + code (undergrad/job-seeking):** [[pillars/05-portfolio-optimization/multi-asset-and-factor-allocation/02-asset-class-allocation|02 · Asset-Class Allocation]] → [[pillars/05-portfolio-optimization/multi-asset-and-factor-allocation/03-factor-based-allocation|03 · Factor-Based Allocation]] → [[pillars/05-portfolio-optimization/multi-asset-and-factor-allocation/04-carry-and-styles|04 · Carry & Styles]].
- **Robustness (practitioner/graduate):** [[pillars/05-portfolio-optimization/multi-asset-and-factor-allocation/05-failure-modes-and-practice|05 · Failure Modes]] → [[pillars/05-portfolio-optimization/multi-asset-and-factor-allocation/06-advanced-extensions|06 · Advanced Extensions]].
