...
- Base: [[foundations/probability-and-measure-theory|Probability & Measure Theory]] (conditional expectation, distributions) · [[foundations/multivariable-calculus-and-optimization|Multivariable Calculus]] (MAP as optimization; HPD as constrained optimization)
- Forward: [[pillars/05-portfolio-optimization/black-litterman-asset-allocation|Black–Litterman Allocation]] · [[pillars/04-quantitative-risk/var-and-expected-shortfall|VaR & Expected Shortfall]] (the predictive distribution is the risk distribution)
