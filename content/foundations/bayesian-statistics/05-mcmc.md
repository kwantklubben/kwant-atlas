...
5. **Bad proposal scaling in high dimensions.** A random-walk MH scales as $O(d^{-1/6})$ optimal step decay; a badly chosen $s$ gives near-zero or near-one acceptance in high dimensions. **Gibbs or HMC** replaces blind proposals with dimension-aware moves.
