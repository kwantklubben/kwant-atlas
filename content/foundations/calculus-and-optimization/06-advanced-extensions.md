...
- Applied: [[pillars/05-portfolio-optimization/modern-portfolio-theory-and-mean-variance|Mean-Variance Optimization]] (the efficient frontier and its slope) · [[pillars/07-machine-learning-altdata/index|Machine Learning]] (ridge/lasso, gradient boosting) · [[pillars/05-portfolio-optimization/covariance-shrinkage-and-denoising|Covariance Shrinkage & Denoising]] (when inputs are uncertain and the problem is ill-conditioned)
- Base: [[foundations/linear-algebra-and-matrices|Linear Algebra & Matrices]] (positive-definite matrices, SVD, quadratic forms) · [[foundations/calculus-and-optimization/04-constrained-optimization|04 · Constrained Optimization]] (KKT, shadow prices)
