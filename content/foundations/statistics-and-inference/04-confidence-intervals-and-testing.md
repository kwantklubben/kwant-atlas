...
- Applications: [[pillars/01-quantitative-research/index|Quantitative Research]] (backtesting, signal validation) · [[pillars/04-quantitative-risk/var-and-expected-shortfall|VaR & Expected Shortfall]] (tail interval estimation) · [[foundations/econometrics-and-timeseries/index|Econometrics]] (ACF/PACF and Ljung–Box are hypothesis tests)
