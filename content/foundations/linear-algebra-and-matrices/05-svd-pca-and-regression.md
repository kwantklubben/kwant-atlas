...
- Forward: [[pillars/01-quantitative-research/fundamental-multi-factor-models|Fundamental Multi-Factor Models]] (regression = the factor engine) · [[pillars/05-portfolio-optimization/covariance-shrinkage-and-denoising|Covariance Shrinkage & Denoising]] · [[pillars/04-quantitative-risk/parametric-historical-and-monte-carlo-var|Parametric & Monte-Carlo VaR]] · [[foundations/econometrics-and-timeseries/index|Econometrics & Time Series]] (OLS/regression diagnostics)
