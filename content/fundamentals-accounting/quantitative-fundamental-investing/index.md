...
- Quantitative bridges: [[pillars/01-quantitative-research/fundamental-multi-factor-models|Fundamental Multi-Factor Models]] (the Barra/FF factor-model construction layer) · [[pillars/01-quantitative-research/backtesting-hygiene-and-deflated-sharpe|Backtesting Hygiene & Deflated Sharpe]] (why a backtested factor premium must be discounted) · [[pillars/05-portfolio-optimization/index|Portfolio Optimization]] (how factor tilts become portfolios)
