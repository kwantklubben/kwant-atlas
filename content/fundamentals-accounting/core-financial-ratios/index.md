...
This folder is the **hub**. It (a) gives you the **fast ratio lookup table** below (job #1 of this folder - this is the single best lookup page in the whole Accounting & Finance area), and (b) routes you to six sub-pages that walk from raw intuition through profitability, valuation multiples, liquidity & leverage, failure modes, and the advanced extension layer (Altman Z, ROIC/ROCE decomposition, the Piotroski F-score).
...
**Beginner:** start at [[fundamentals-accounting/core-financial-ratios/01-from-zero-intuition|01]] · **Practitioner:** start at [[fundamentals-accounting/core-financial-ratios/05-failure-modes-and-practice|05]]
